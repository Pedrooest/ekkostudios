...
import { FileOutput, X, FileSpreadsheet, ChevronRight, Image, FileText, Loader2 } from 'lucide-react';
            ...
            <div className="bg-[#111118] border border-[#24243A] rounded-2xl w-[95vw] md:w-[500px] overflow-hidden shadow-2xl transform transition-all scale-100">
                ...
                <div className="p-8 grid gap-4">
                    ...
                    >
                        ...
                        <ChevronRight size={16} className="text-[#24243A] group-hover:text-[#10b981] transition-colors" />
                    </button>
                    ...
                    >
                        ...
                        <ChevronRight size={16} className="text-[#24243A] group-hover:text-[#C8A24A] transition-colors" />
                    </button>
                    ...
                    >
                        ...
                        <ChevronRight size={16} className="text-[#24243A] group-hover:text-rose-500 transition-colors" />
                    </button>
                ...
                {isProcessing && (
                    <div className="px-6 py-3 bg-[#C8A24A]/10 text-[#C8A24A] text-xs font-bold text-center border-t border-[#C8A24A]/20">
                        <Loader2 size={14} className="animate-spin mr-2 inline" /> PROCESSANDO EXPORTAÇÃO...
                    </div>
                )}
            </div>
        </div>
