...
-- POLICIES BÁSICAS (Exemplo: todos usuários autenticados podem ver/editar se pertencerem ao workspace)
-- Nota: O usuário pode precisar ajustar as políticas conforme as regras específicas de negócio
-- Aqui apenas garantimos que o RLS está ativo para evitar acessos diretos desprotegidos.
